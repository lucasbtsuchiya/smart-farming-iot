...
def saveToDatabase(humidadesolo):
	...
	con=mdb.connect("localhost", databaseUsername, databasePassword, databaseName)
        ...
        with con:
                ...
                cur.execute("INSERT INTO solo (humidadesolo, dateMeasured, hourMeasured) VALUES (%s,%s,%s)",(humidadesolo,currentDate, minutes))

		print "Humidade do Solo salva"
		return "true"
